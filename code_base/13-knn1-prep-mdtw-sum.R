...
# f_sep_each <- list()
# for(i in 1:52){
#   f_sep_each[[i]] <- readRDS(paste0(dataPath, 'Ripoll2014/REVISION-RIPOLL/dtw-sep-feats/sepfull-default-feat', i, '.RData'))
...
# 
# fsum_sep[1:6, 1:6]
# saveRDS(fsum_sep, file = paste0(dataPath, 'Ripoll2014/REVISION-RIPOLL/dtw-sep-feats/mdtw-sep.RData'))
...
# fsum_aki[1:6, 1:6]
# fsum_aki %>% dim
saveRDS(fsum_aki, file = paste0(dataPath, 'AKI/REVISION-AKI/dtw-aki-proc/mdtw-aki.RData'))
